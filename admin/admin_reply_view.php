...
<body>
    ...
    <script src="./js/admin_reply.js"></script>
    <div class="area"></div>
    <nav class="main-menu">
        <ul>
            <li>
    ...
    <div id="main_wrap">
        <div class="container text-center">
            ...
            <div class=" mt-3 d-flex gap-2 justify-content-end">
                <button class="btn btn-primary" id="btn_write_edit" data-idx="<?= $row['idx'] ?>">수정</button>
                <button class="btn btn-danger" id="btn_delete" data-idx="<?= $replyrow['reply_id'] ?>">삭제</button>
                <button class="btn btn-secondary" id="btn_board_list" data-idx="<?= $row['idx'] ?>">본문보기</button>
            </div>
        </div>
    </div>
